...
module alu_add (
 ...
 logic lt_result;  logic gt_result;     always_comb begin
        _a              = A;
        _b              = B;
        ...
        overflow_flag   = 1'b0;
        zero_flag       = 1'b0;
 lt_result = 1'b0;  gt_result = 1'b0;         if (en) begin
 ...
 lt_result = (sign_flag ^ overflow_flag);  gt_result = !(sign_flag ^ overflow_flag || zero_flag);             case (opcode)
